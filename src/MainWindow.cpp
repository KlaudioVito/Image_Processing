...
MainWindow::createActions()
{
	...
	m_actionBlurSingle = new QAction("Blur w/ Single &Pass", this);
	m_actionBlurSingle->setShortcut(tr("Ctrl+P"));
	m_actionBlurSingle->setData(BLURSINGLE);

	m_actionCorrelate = new QAction("Corre&late", this);
	m_actionCorrelate->setShortcut(tr("Ctrl+L"));
	m_actionCorrelate->setData(CORRELATE);
...
MainWindow::createMenus()
{
	...
	m_menuNbrOps->addAction(m_actionBlurSingle );
	m_menuNbrOps->addAction(m_actionCorrelate  );
...
MainWindow::createGroupPanel()
{
	...
	m_imageFilter[BLURSINGLE] = new BlurSingle;
	m_imageFilter[CORRELATE] = new Correlate;
	...
	m_stackWidgetPanels->addWidget(m_imageFilter[BLURSINGLE]->controlPanel());
	m_stackWidgetPanels->addWidget(m_imageFilter[CORRELATE]->controlPanel());
